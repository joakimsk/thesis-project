...
{ public:
	...
	virtual	int GetServiceCapabilities(_tptz__GetServiceCapabilities *tptz__GetServiceCapabilities, _tptz__GetServiceCapabilitiesResponse *tptz__GetServiceCapabilitiesResponse) { return GetServiceCapabilities(NULL, NULL, tptz__GetServiceCapabilities, tptz__GetServiceCapabilitiesResponse); }
	...
	virtual	int GetConfigurations(_tptz__GetConfigurations *tptz__GetConfigurations, _tptz__GetConfigurationsResponse *tptz__GetConfigurationsResponse) { return GetConfigurations(NULL, NULL, tptz__GetConfigurations, tptz__GetConfigurationsResponse); }
	...
	virtual	int GetPresets(_tptz__GetPresets *tptz__GetPresets, _tptz__GetPresetsResponse *tptz__GetPresetsResponse) { return GetPresets(NULL, NULL, tptz__GetPresets, tptz__GetPresetsResponse); }
	...
	virtual	int SetPreset(_tptz__SetPreset *tptz__SetPreset, _tptz__SetPresetResponse *tptz__SetPresetResponse) { return SetPreset(NULL, NULL, tptz__SetPreset, tptz__SetPresetResponse); }
	...
	virtual	int RemovePreset(_tptz__RemovePreset *tptz__RemovePreset, _tptz__RemovePresetResponse *tptz__RemovePresetResponse) { return RemovePreset(NULL, NULL, tptz__RemovePreset, tptz__RemovePresetResponse); }
	...
	virtual	int GotoPreset(_tptz__GotoPreset *tptz__GotoPreset, _tptz__GotoPresetResponse *tptz__GotoPresetResponse) { return GotoPreset(NULL, NULL, tptz__GotoPreset, tptz__GotoPresetResponse); }
	...
	virtual	int GetStatus(_tptz__GetStatus *tptz__GetStatus, _tptz__GetStatusResponse *tptz__GetStatusResponse) { return GetStatus(NULL, NULL, tptz__GetStatus, tptz__GetStatusResponse); }
	...
	virtual	int GetConfiguration(_tptz__GetConfiguration *tptz__GetConfiguration, _tptz__GetConfigurationResponse *tptz__GetConfigurationResponse) { return GetConfiguration(NULL, NULL, tptz__GetConfiguration, tptz__GetConfigurationResponse); }
	...
	virtual	int GetNodes(_tptz__GetNodes *tptz__GetNodes, _tptz__GetNodesResponse *tptz__GetNodesResponse) { return GetNodes(NULL, NULL, tptz__GetNodes, tptz__GetNodesResponse); }
	...
	virtual	int GetNode(_tptz__GetNode *tptz__GetNode, _tptz__GetNodeResponse *tptz__GetNodeResponse) { return GetNode(NULL, NULL, tptz__GetNode, tptz__GetNodeResponse); }
	...
	virtual	int SetConfiguration(_tptz__SetConfiguration *tptz__SetConfiguration, _tptz__SetConfigurationResponse *tptz__SetConfigurationResponse) { return SetConfiguration(NULL, NULL, tptz__SetConfiguration, tptz__SetConfigurationResponse); }
	...
	virtual	int GetConfigurationOptions(_tptz__GetConfigurationOptions *tptz__GetConfigurationOptions, _tptz__GetConfigurationOptionsResponse *tptz__GetConfigurationOptionsResponse) { return GetConfigurationOptions(NULL, NULL, tptz__GetConfigurationOptions, tptz__GetConfigurationOptionsResponse); }
	...
	virtual	int GotoHomePosition(_tptz__GotoHomePosition *tptz__GotoHomePosition, _tptz__GotoHomePositionResponse *tptz__GotoHomePositionResponse) { return GotoHomePosition(NULL, NULL, tptz__GotoHomePosition, tptz__GotoHomePositionResponse); }
	...
	virtual	int SetHomePosition(_tptz__SetHomePosition *tptz__SetHomePosition, _tptz__SetHomePositionResponse *tptz__SetHomePositionResponse) { return SetHomePosition(NULL, NULL, tptz__SetHomePosition, tptz__SetHomePositionResponse); }
	...
	virtual	int ContinuousMove(_tptz__ContinuousMove *tptz__ContinuousMove, _tptz__ContinuousMoveResponse *tptz__ContinuousMoveResponse) { return ContinuousMove(NULL, NULL, tptz__ContinuousMove, tptz__ContinuousMoveResponse); }
	...
	virtual	int RelativeMove(_tptz__RelativeMove *tptz__RelativeMove, _tptz__RelativeMoveResponse *tptz__RelativeMoveResponse) { return RelativeMove(NULL, NULL, tptz__RelativeMove, tptz__RelativeMoveResponse); }
	...
	virtual	int SendAuxiliaryCommand(_tptz__SendAuxiliaryCommand *tptz__SendAuxiliaryCommand, _tptz__SendAuxiliaryCommandResponse *tptz__SendAuxiliaryCommandResponse) { return SendAuxiliaryCommand(NULL, NULL, tptz__SendAuxiliaryCommand, tptz__SendAuxiliaryCommandResponse); }
	...
	virtual	int AbsoluteMove(_tptz__AbsoluteMove *tptz__AbsoluteMove, _tptz__AbsoluteMoveResponse *tptz__AbsoluteMoveResponse) { return AbsoluteMove(NULL, NULL, tptz__AbsoluteMove, tptz__AbsoluteMoveResponse); }
	...
	virtual	int Stop(_tptz__Stop *tptz__Stop, _tptz__StopResponse *tptz__StopResponse) { return Stop(NULL, NULL, tptz__Stop, tptz__StopResponse); }
	...
	virtual	int GetPresetTours(_tptz__GetPresetTours *tptz__GetPresetTours, _tptz__GetPresetToursResponse *tptz__GetPresetToursResponse) { return GetPresetTours(NULL, NULL, tptz__GetPresetTours, tptz__GetPresetToursResponse); }
	...
	virtual	int GetPresetTour(_tptz__GetPresetTour *tptz__GetPresetTour, _tptz__GetPresetTourResponse *tptz__GetPresetTourResponse) { return GetPresetTour(NULL, NULL, tptz__GetPresetTour, tptz__GetPresetTourResponse); }
	...
	virtual	int GetPresetTourOptions(_tptz__GetPresetTourOptions *tptz__GetPresetTourOptions, _tptz__GetPresetTourOptionsResponse *tptz__GetPresetTourOptionsResponse) { return GetPresetTourOptions(NULL, NULL, tptz__GetPresetTourOptions, tptz__GetPresetTourOptionsResponse); }
	...
	virtual	int CreatePresetTour(_tptz__CreatePresetTour *tptz__CreatePresetTour, _tptz__CreatePresetTourResponse *tptz__CreatePresetTourResponse) { return CreatePresetTour(NULL, NULL, tptz__CreatePresetTour, tptz__CreatePresetTourResponse); }
	...
	virtual	int ModifyPresetTour(_tptz__ModifyPresetTour *tptz__ModifyPresetTour, _tptz__ModifyPresetTourResponse *tptz__ModifyPresetTourResponse) { return ModifyPresetTour(NULL, NULL, tptz__ModifyPresetTour, tptz__ModifyPresetTourResponse); }
	...
	virtual	int OperatePresetTour(_tptz__OperatePresetTour *tptz__OperatePresetTour, _tptz__OperatePresetTourResponse *tptz__OperatePresetTourResponse) { return OperatePresetTour(NULL, NULL, tptz__OperatePresetTour, tptz__OperatePresetTourResponse); }
	...
	virtual	int RemovePresetTour(_tptz__RemovePresetTour *tptz__RemovePresetTour, _tptz__RemovePresetTourResponse *tptz__RemovePresetTourResponse) { return RemovePresetTour(NULL, NULL, tptz__RemovePresetTour, tptz__RemovePresetTourResponse); }
	...
	virtual	int GetCompatibleConfigurations(_tptz__GetCompatibleConfigurations *tptz__GetCompatibleConfigurations, _tptz__GetCompatibleConfigurationsResponse *tptz__GetCompatibleConfigurationsResponse) { return GetCompatibleConfigurations(NULL, NULL, tptz__GetCompatibleConfigurations, tptz__GetCompatibleConfigurationsResponse); }
